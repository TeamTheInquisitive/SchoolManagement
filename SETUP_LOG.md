...
# 4. Edit .env — set your local MySQL credentials
# MYSQL_USER=root
# MYSQL_PASSWORD=password

# 5. Install & start MySQL
brew install mysql
...
**Error:** FK dependency ordering issues when creating tables.
...
### Issue #5: Redis not running — server crashes on startup
...
### Issue #6: `ImportError: cannot import name 'Staff' from 'src.models.core'`
...
- MySQL 8.0 via Docker or Homebrew on macOS
