...
export const useAnalyticsGenderRatio = () =>
  useQuery({ queryKey: ['analytics', 'gender-ratio'], queryFn: () => api.get(EP.analyticsGenderRatio).then(r => r.data).catch(() => ({ male: 0, female: 0, other: 0, total: 0 })) });
