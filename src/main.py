...
# Catch all unhandled exceptions and return error details in JSON response
import traceback
...
# Replace default error handler with our JSON one
app.add_middleware(ServerErrorMiddleware, handler=_error_handler)
