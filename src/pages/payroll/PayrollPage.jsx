...
export default function PayrollPage() {
  ...
  return (
    <div>
      ...
      <div className="mb-6"><h1 className="text-2xl md:text-3xl font-bold text-slate-900">Payroll</h1><p className="text-sm text-slate-500 mt-1">Manage staff directory, payroll, leaves, and salary advances</p></div>
