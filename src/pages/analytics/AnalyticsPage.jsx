...
export default function AnalyticsPage() {
  ...
  const { data: genderRatio } = useAnalyticsGenderRatio();
  ...
  const gender = genderRatio || { male: 0, female: 0, other: 0, total: 0 };
  ...
  const genderPieData = [
    ...
    ...(gender.other > 0 ? [{ name: 'Other', value: gender.other, color: '#8b5cf6' }] : []),
  ].filter(d => d.value > 0);
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-4">
        ...
        <ChartCard title="Gender Distribution" subtitle={`Total: ${gender.total} students`} className="md:col-span-4">
          {genderPieData.length > 0 ? (
            <div>
              <ResponsiveContainer width="100%" height={180}>
                <PieChart>
                  <Pie data={genderPieData} cx="50%" cy="50%" innerRadius={50} outerRadius={75} dataKey="value" paddingAngle={3}>
