...
export default function TeacherDetailsPage() {
  ...
  useEffect(() => {
    if (teacher && id) {
      addItem({ id, name: teacher.user?.full_name || teacher.full_name, type: 'teacher', path: '/admin/teachers/' + id, subtitle: teacher.department });
    }
  }, [teacher, id]);
  ...
  return (
    <TeacherDetailView
      ...
      breadcrumbItems={[{ label: 'Dashboard', href: '/admin/dashboard' }, { label: 'Teacher Profile' }]}
