...
const PAGES = [
  ...
  { path: '/admin/staff', label: 'Staff', icon: GraduationCap, keywords: 'teacher faculty employee staff' },
  { path: '/admin/payroll', label: 'Payroll', icon: Briefcase, keywords: 'staff salary payroll hr' },
