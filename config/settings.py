...
# CSRF - needed for cookie-based auth
...
# OAuth2 Settings (for Exam Portal SSO)
OAUTH2_PROVIDER = {
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@schoolportal.com')
